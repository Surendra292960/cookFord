    ...
    EditCookProfileForm(
        ...
        onProfileImageChange = { inputString ->
            ...
            addCookProfileViewModel.onUiEvent(
                addCookProfileUiEvent = EditCookProfileUiEvent.ProfileImageChanged(
                    inputString
                )
            )
        },
        ...
        onJobTypeChange = { inputString ->
            Log.d("TAG", "CookProfileForm: $inputString")
            addCookProfileViewModel.onUiEvent(
                addCookProfileUiEvent = EditCookProfileUiEvent.JobTypeChange(
                    inputString
                )
            )
        },
        ...
        onUserNameChange = { inputString ->
            Log.d("TAG", "CookProfileForm: $inputString")
            addCookProfileViewModel.onUiEvent(
                addCookProfileUiEvent = EditCookProfileUiEvent.UserNameChanged(
                    inputString
                )
            )
        },
        onPhoneChange = { inputString ->
            addCookProfileViewModel.onUiEvent(
                addCookProfileUiEvent = EditCookProfileUiEvent.PhoneChanged(
                    inputString
                )
            )
        },
        onAlternatePhoneChange = { inputString ->
            addCookProfileViewModel.onUiEvent(
                addCookProfileUiEvent = EditCookProfileUiEvent.AlternatePhoneChanged(
                    inputString
                )
            )
        },
        onGenderChange = { inputString ->
            ...
            addCookProfileViewModel.onUiEvent(
                addCookProfileUiEvent = EditCookProfileUiEvent.GenderChange(
                    inputString
                )
            )
        },
        onCityChange = { inputString ->
            Log.d("TAG", "CookProfileForm: $inputString")
            addCookProfileViewModel.onUiEvent(
                addCookProfileUiEvent = EditCookProfileUiEvent.CityChanged(
                    inputString
                )
            )
        },
        onSubmit = {
            addCookProfileViewModel.onUiEvent(addCookProfileUiEvent = EditCookProfileUiEvent.Submit)
        },
