package com.example.cook_ford.presentation.screens.un_authenticated_component.landind_screen_component
...
@Composable
fun PreviewScreen(){
    LandingScreen(navController = rememberNavController(), onNavigateToUserSignInRoute = {}, onNavigateToCookSignInRoute = {})
}

@Composable
fun LandingScreen(navController: NavController, onNavigateToUserSignInRoute:()-> Unit, onNavigateToCookSignInRoute:()-> Unit) {
    ...
    Column(modifier = Modifier
       ...
       /* OutlinedSmallSubmitButton(
        ...
        OutlinedSmallSubmitButton(
            modifier = Modifier.padding(top = 10.dp, bottom = 10.dp),
            textColor = Color.Gray,
            text = stringResource(id = R.string.sign_in_as_a_user_button_text),
            isLoading = false,
            onClick = { onNavigateToUserSignInRoute.invoke() }
        )
        ...
        OutlinedSmallSubmitButton(
            ...
            isLoading = false,
            onClick = { onNavigateToCookSignInRoute.invoke() }
        )
