...
import com.example.cook_ford.presentation.route.CookHomeNavGraph
...
fun HomeScreen(
    ...
    LaunchedEffect(navController) {
        navController.currentBackStackEntryFlow.collect { backStackEntry ->
            ...
            appBarTitle.value = backStackEntry.destination.route?.let {
                Log.d("TAG", "UserDashBoard: ${getTitleByRoute(it)}")
                getTitleByRoute(it)
            }!!
...
fun Preview() {
    Cook_fordTheme {
        HomeScreen(onNavigateToAuthenticatedRoute = {})
    }
}