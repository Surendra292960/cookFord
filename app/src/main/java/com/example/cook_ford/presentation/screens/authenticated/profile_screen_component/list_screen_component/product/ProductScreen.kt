package com.example.cook_ford.presentation.screens.authenticated.profile_screen_component.list_screen_component.product
...
fun AboutSection(
    ...
    Column(
        ...
        Text(text = productDescription, color = Color.Black)
        Spacer(modifier = Modifier.height(4.dp))
        Row(
            modifier = Modifier
                .fillMaxWidth()
            ...
            Row(
                ...
                Icon(
                    painter = painterResource(id = com.example.cook_ford.R.drawable.star_full),
                    contentDescription = null,
...
fun SizeItem(
    ...
    Box(
        ...
        Text(text = size, fontSize = 18.sp, color = Color.Black)
    }
}
...
@Composable
fun PreviewScreen() {
    ProductScreen( id = products[1].id)
}