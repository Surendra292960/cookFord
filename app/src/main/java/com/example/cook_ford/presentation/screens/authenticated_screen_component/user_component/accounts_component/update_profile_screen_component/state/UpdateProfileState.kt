package com.example.cook_ford.presentation.screens.authenticated_screen_component.user_component.accounts_component.update_profile_screen_component.state
...
data class UpdateProfileState(
    ...
    val errorState: UpdateProfileErrorState = UpdateProfileErrorState(),
 ...
 */
data class UpdateProfileErrorState(
