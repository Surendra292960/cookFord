...
object AppConstants {
   ...
   // const val AUTH_PREFERENCES = "AUTH_PREF"
    ...
    const val NO_OF_VISIT = "Number of visit"
    const val SELECT_COOK_CITY = "Select cook`s city"
    const val WORK_AREA = "Work Area (Count)"
   const val WORK_AREA_SUBTEXT = "(For Part-time/Full-day work)"
    const val COOK_TYPE = "Cook Type"
    const val FOOD_TYPE =  "Cooks non-veg?"
